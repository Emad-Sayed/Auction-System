...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2018 at 03:50 PM
...
INSERT INTO `bill` (`ID`, `Item_ID`, `Date_Id`, `User_ID`, `DM_ID`) VALUES
(1, 1, 17, 4, 3),
(2, 3, 18, 6, 9),
(3, 5, 17, 11, 9);
...
(1, 2, 3, 'Hello', 9, 1),
(2, 2, 2, 'Hello', 9, 1),
(3, 4, 3, 'hello emad', 22, 1),
(4, 3, 4, 'Hello salah', 22, 1),
(5, 5, 3, 'asads', 22, 1);
...
INSERT INTO `observer` (`Observer_id`, `User_ID`, `Content`, `State_id`) VALUES
(1, 2, 'hELLO', 2);
...
(1, 'Mohamed', 'Salah', 's@yahoo.com', '1', 1, 2992, 1),
(2, 'K', 'Alaa', 'k@gmail.com', 'aaaa1111', 2, 99119, 1),
(3, 'Emad', 'Sayed', 'e@gmail.com', '1', 3, 8000, 2),
(4, 'Mahmoud', 'Abdelrazek', 'm@yahoo.com', '1', 4, 20000, 2),
(5, 'Abdalla', 'mohamed', 'a@yahoo.com', '1', 5, 100000, 3),
(6, 'asmaa', 'Ali', 'Asmaa123@gmail.com', '74125896', 4, 5000, 1),
(7, 'ola', 'Ahmed', 'Olaahmed14@gmail.com', '32147896', 5, 8000, 2),
(8, 'Omar', 'Mohamed', 'Omarmohamed12@gmail.com', '1234578', 5, 500078, 4),
(9, 'waleed', 'mohamed', 'waleed15@gmail.com', '15984762', 3, 50, 1),
(10, 'Sara', 'Ali', 'sara12@gmail.com', '12345678', 5, 9000, 4),
(11, 'Reda', 'Salem', 'redasalem147@gmail.com', '14785236', 4, 95000, 1),
...
(37, 'mohamed', 'salah', 'mohamed@gmail.com', '123456mo', 4, 0, 1);
...
INSERT INTO `user_avilable_time` (`ID`, `User_ID`, `Date_ID`, `Item_ID`) VALUES
(3, 4, 17, 2);
...
--
ALTER TABLE `observer`
  MODIFY `Observer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `sequrityq_user`
  MODIFY `SequrityQ_U_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
